## R-Script - Obtaning the continuous wavelet analysis variables from hyperspectral data for the reflectance and first derivative of the data
...
# WAfit : find the best family using autopls package. Input variable is the observed variable only. e.g. WA_fit(Biomass)
...
# bestWA: see wich WA variables had the best fit. The input data are: WA_fit (r2_all_ref, rmse_all_ref, r2_all_deriv, rmse_all_deriv) 
